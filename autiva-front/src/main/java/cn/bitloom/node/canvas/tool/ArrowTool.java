...
import cn.bitloom.node.canvas.model.ArrowElement;
...
public class ArrowTool implements CanvasTool {
    ...
    public void onMousePressed(MouseEvent e, CanvasScene scene) {
        ...
        currentElement = new ArrowElement();

...
public class BotMessageConsumer implements OpenDingTalkCallbackListener<ChatbotMessage, Void> {
    ...
    private Session bindSession(ChatbotMessage botMessage) {
        Session session = sessionManager.getOrCreate(SOURCE, SessionTypeEnum.DM, SessionRespTypeEnum.BLOCK, botMessage.getConversationId());

 ...
 * 而不是AI智能体。
 * 需要设置<code>spring.ai.tools.throw-exception-on-error=cn.bitloom.agentic.tool.interaction.AskUserQuestionTool$InvalidUserAnswerException</code>
 * 以启用此行为。
 *
 * @see <a href=
 ...
 * Agent SDK - 问题格式</a>
 */
public class AskUserQuestionTool extends AbstractTool<AskUserQuestionTool.Input> {
	...
	private AskUserQuestionTool(QuestionHandler questionHandler, boolean answersValidation) {
		super("AskUserQuestionTool", DESCRIPTION, Input.class);

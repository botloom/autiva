 ...
 * 而不是AI智能体。
 * 需要设置<code>spring.ai.tools.throw-exception-on-error=cn.bitloom.agentic.tool.core.AskUserQuestionTool$InvalidUserAnswerException</code>
 * 以启用此行为。
 *
 * @see <a href=
...
public class AskUserQuestionTool {
	...
	@Tool(name = "AskUserQuestionTool",
			description = """
					...
					""")
	public ToolResult askUserQuestion(

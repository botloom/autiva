...
你的长期记忆（MEMORY.md）通过记忆工具维护。了解到关于用户的新信息（职业、偏好、习惯、反馈等）时，立即使用 memory_save 或 memory_update 写入记忆。回答关于用户偏好、历史事件的问题前，先使用 memory_search 搜索相关记忆。

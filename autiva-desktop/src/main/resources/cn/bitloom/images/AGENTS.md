...
#### folder.svg
文件夹图标（Apple Blue #0071e3 描边）。

**用途：**
- ButtonBar 的"项目"按钮图标（蓝色，与终端/变更按钮风格一致）
- 文件编辑器中的文件夹图标（文件树）
...
**用途：**
- 输入区域的项目选择按钮图标（黑色，区别于 ButtonBar 的蓝色 folder.svg）
...
#### diff.svg
变更/Diff 图标（双面板 + 加号/减号，Apple Blue #0071e3 描边）。

**用途：**
- ButtonBar 的"变更"按钮图标（蓝色，区别于其他按钮）

#### terminal.svg
终端图标（矩形框 + 大于号 + 下划线，Apple Blue #0071e3 描边）。
